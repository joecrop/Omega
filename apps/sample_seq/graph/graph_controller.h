#ifndef SAMPLE_GRAPH_CONTROLLER_H
#define SAMPLE_GRAPH_CONTROLLER_H
...
namespace Sample
{
  ...
  private:
    ...
    SampleStore *functionStore() const override { return static_cast<SampleStore *>(Shared::FunctionGraphController::functionStore()); }
