#ifndef SAMPLE_SEQUENCE_CONTEXT_H
#define SAMPLE_SEQUENCE_CONTEXT_H
...
namespace Sample
{
  ...
  public:
    ...
    void resetCache();
    bool iterateUntilRank(int n, SampleStore *sequenceStore, SequenceContext *sqctx);
   ...
   * from n. */
    void step(SampleStore *sequenceStore, SequenceContext *sqctx);
    int m_rank;
  ...
  {
  public:
    SequenceContext(Poincare::Context *parentContext, SampleStore *sequenceStore) : ContextWithParent(parentContext),
