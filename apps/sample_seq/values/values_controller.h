#ifndef SAMPLE_VALUES_CONTROLLER_H
#define SAMPLE_VALUES_CONTROLLER_H
...
namespace Sample
{
  ...
  private:
    ...
    // Model getters
    SampleStore *functionStore() const override { return static_cast<SampleStore *>(Shared::ValuesController::functionStore()); }
