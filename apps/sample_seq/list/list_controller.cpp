...
namespace Sample
{
  ...
  ListController::ListController(Responder *parentResponder, ::InputEventHandlerDelegate *inputEventHandlerDelegate, ButtonRowController *header, ButtonRowController *footer) : Shared::FunctionListController(parentResponder, header, footer, I18n::Message::AddSequence),
  ...
  {
    int numberOfRows = 0;
    SampleStore *store = const_cast<ListController *>(this)->modelStore();
  ...
  SampleStore *ListController::modelStore()
  {
